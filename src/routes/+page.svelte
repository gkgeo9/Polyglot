...
<div class="flex max-md:flex-col h-screen">
	...
	<div class="w-1/2 p-8">
		...
		<pre class="rounded-md max-md:w-screen"><code class="language-javascript">{gptJS}</code></pre>
		<p class="text-white">Python🐍</p>
		<pre class="rounded-md max-md:w-screen"><code class="language-python">{gptPython}</code></pre>
		<p class="text-white">C++🐢</p>
		<pre class="rounded-md max-md:w-screen"><code class="language-clike">{gptCPP}</code></pre>
		<p class="text-white">Java☕</p>
		<pre class="rounded-md max-md:w-screen"><code class="language-java">{gptJava}</code></pre>
	</div>
</div>
